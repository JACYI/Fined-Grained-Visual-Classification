...
# process bar test
def process_bar(percent, batch_idx, start_str='', end_str='', total_length=0):
    bar = ''.join(["\033[0;30;47m%s\033[0m"%'   '] * int(percent * total_length)) + ''
    bar = '\r' + start_str + bar.ljust(total_length) + ' {:.0f}|'.format(batch_idx) + end_str
